...
Slow Rotation
-------------
Rotates the starting vector in a circle
...
Press any key to toggle rotation on and off
...
boolean rotate = true; // Slowly rotate the line
...
void draw() {
  ...
  if(rotate) angle = (angle + 0.005) % 360; // Every draw loop, increase the angle. Reset to 0 at 360°.
